...
function makeNPC($type = 'any', $title) {
	...
	switch($type) {
		...
		case('fixer'):
			$whoList = array (
				'Anna Nelson - Anna was the child of a couple placed with the Jode Nation in a witness protection scheme. A data breach exposed their real identities and they were swiftly killed soon after, with Anna lucky to escape injury. She found her mediation skills translated well from nomad families to Night City gangs. She&#39;s usually flying solo but never far from a "pack" of some description. She&#39;s the archtypical someone-who-knows-someone and can often be found gossiping with the Moxes at Lizzy&#39;s.',
				'Dino Dinovic - Dino was an itinerant muso, never really successful, guitarist for bands that opened for Shatter, Karl Remiel, even Kerry Eurodyne. Real success never came for him though, not before he realised that a) the drug-fuelled existence was getting to him and b) he was getting a lot more eddies from procuring goods and people for fellow band-members. So it was the Dino turned from axe-grinding to a career as a fixer.',
		...
		case('tech'):
			$whoList = array(
				'Ptolemy Biraz - Slow moving, heavy set biotech genius, he suffers from a rare immune disorder that means his body rejects even the simplest invasive cyberwear. As a result, he tends to avoid the city when he can, unable to handle toxicity levels that most folk with nasal filters aren&#39;t aware of. An almost psychic level of problem solving, he has been known to solve problems for people before they have been able to finish asking for help.',
				'Alita Alvarez - College graduate, eager to the point of intimidation and the attention-span/focus ability that comes with top talent, Alita has an almost instinctual understanding of A.I. that earned her a scholarship to Night City University, but also frustrates her lecturers who understand that she is two steps ahead of them but cannot understand her reasoning as to how.',
				"Finn O'Calaghan - Grumpy, paranoid, old agoraphobic who has jerry rigged more stable tech than some companies can produce on a factory line.",
