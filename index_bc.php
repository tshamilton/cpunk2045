...
<!--			<div class="d-flex justify-content-between align-items-center breaking-news bg">
					<div class="d-flex flex-row flex-grow-1 justify-content-center py-2 px-1 news"><span class="d-flex text-align-center align-items-center">&nbsp;<?php print pickCorp('Media'); ?> News</span></div>
				...
				<div class="breaking-news breaking-news-title bg">
					<div class="text-center"><span class="">&nbsp;<?php print pickCorp('Media'); ?> News</span></div>
					<marquee class="breaking-news" behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();"> <?php $bcl = bc_lotto(); print $bcl; ?> </marquee>
				</div>
			</div>
		</div>
		<div class="row">
